...
def GroupAddName(builder, name): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return GroupAddName(builder, name)
...
def GroupAddMembers(builder, members): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(members), 0)
def AddMembers(builder, members):
    return GroupAddMembers(builder, members)
def GroupStartMembersVector(builder, numElems): return builder.StartVector(4, numElems, 4)
